...
const PROJECT_ITEMS: ProjectItem[] = [
  ...
  },
  {
    ...
    screenshots: [{ src: "/screenshots-real/real-estate-real.png", alt: "Real Estate Application live interface" }],
    links: [
  ...
  },
  {
    ...
    screenshots: [{ src: "/screenshots-real/maasba-real.png", alt: "Maasba Project live login interface" }],
    links: [
  ...
  },
  {
    ...
    links: [{ label: "Code", href: "https://github.com/tayebzitouni/PrimaryConnect" }],
  },
  {
  ...
  },
  {
    ...
    links: [{ label: "Code", href: "https://github.com/tayebzitouni/KayGroup" }],
  },
  {
